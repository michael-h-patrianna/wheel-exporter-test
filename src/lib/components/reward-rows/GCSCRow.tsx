    ...
    <div className="result-highlight-box" style={buildBoxStyle(bgStyle)}>
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <span style={buildTextStyle(rewards?.prizes?.texts?.gcValue, 18 * scale)}>{gcValue}</span>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <span style={buildTextStyle(rewards?.prizes?.texts?.scValue, 18 * scale)}>{scValue}</span>
        </div>
      </div>
    </div>
  );
